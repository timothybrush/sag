...
const repoBase = "https://github.com/steipete/sag";
const repoEditBase = `${repoBase}/edit/main/docs`;
const cname = readCname();
const siteBase = cname ? `https://${cname}` : "";

const productName = "sag";
const productTagline = "ElevenLabs speech, mac-style ease";
const productDescription =
  "sag is a Go CLI that turns text into ElevenLabs speech the way macOS `say` does. Stream to speakers, save to files, swap voices, choose models — one binary, terminal-first.";
const brewInstall = "brew install steipete/tap/sag";

const sections = [
  ["Start", ["index.md", "install.md", "quickstart.md", "configuration.md"]],
  ["Speak", ["speak.md", "voices.md", "prompting.md", "models.md"]],
  ["Output", ["streaming.md", "formats.md", "timeouts.md"]],
  ["Use", ["agents.md", "say-compatibility.md"]],
  ["Reference", ["architecture.md", "troubleshooting.md", "spec.md", "RELEASING.md", "releasing-homebrew.md"]],
];
...
function homeHero(page) {
  ...
  const quickstartRel = pageMap.get("quickstart.md")?.outRel
    ...
    : "quickstart.html";
  const features = ["macOS say-style", "Streaming", "Voice search", "v3 + v2 models", "MP3 / WAV / Opus", "afplay + oto"];
  return `<header class="home-hero">
        <p class="eyebrow">ElevenLabs · One CLI</p>
        ...
        <div class="home-services" aria-label="Highlights">
    ...
    <aside class="sidebar">
      <div class="sidebar-head">
        <a class="brand" href="${hrefToOutRel("index.html", page.outRel)}" aria-label="${productName} docs home">
          ...
          <span><strong>${escapeHtml(productName)}</strong><small>ElevenLabs CLI docs</small></span>
        </a>
        ${themeToggleHtml()}
      </div>
      <label class="search"><span>Search</span><input id="doc-search" type="search" placeholder="voices, models, streaming"></label>
...
function navTitle(page) {
  ...
  return page.title.replace(/^`sag\s*/, "").replace(/`$/, "");
}
