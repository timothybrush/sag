...
:root{
  ...
  --wave-1:#7c3aed;--wave-2:#a855f7;--wave-3:#ec4899;--wave-4:#f59e0b;
  --line:#e5e7eb;
  --line-soft:#eef0f3;
  --code-bg:#1a1325;
  --code-fg:#e8e0f5;
...
.brand .mark{display:flex;align-items:center;gap:3px;flex:0 0 auto;height:28px;padding:0 4px;border-radius:8px;background:var(--ink)}
.brand .mark i{display:block;width:3px;border-radius:2px;background:var(--wave-1)}
.brand .mark i:nth-child(1){height:8px;background:var(--wave-1)}
.brand .mark i:nth-child(2){height:18px;background:var(--wave-2)}
.brand .mark i:nth-child(3){height:24px;background:var(--wave-3)}
.brand .mark i:nth-child(4){height:14px;background:var(--wave-4)}
.brand .mark i:nth-child(5){height:6px;background:var(--wave-2)}
...
.home-hero h1{font-size:3.25rem;line-height:1.04;letter-spacing:-0.01em;margin:0 0 .35em;font-weight:700;color:var(--ink);background:linear-gradient(95deg,var(--wave-1),var(--wave-2),var(--wave-3),var(--wave-4));-webkit-background-clip:text;background-clip:text;color:transparent}
...
.home-install{display:flex;align-items:center;gap:12px;background:var(--code-bg);color:var(--code-fg);border-radius:8px;padding:10px 10px 10px 16px;font:500 .9rem/1.2 "JetBrains Mono","SF Mono",ui-monospace,monospace;max-width:38em;border:1px solid #2a233e}
.home-install .prompt{color:#9b8fc7;user-select:none;flex:0 0 auto}
...
.doc pre{position:relative;overflow:auto;background:var(--code-bg);color:var(--code-fg);border-radius:8px;padding:14px 18px;margin:1.3em 0;font-size:.85em;line-height:1.6;scrollbar-width:thin;scrollbar-color:#3f3357 transparent;border:1px solid #2a233e}
.doc pre::-webkit-scrollbar{height:8px;width:8px}
.doc pre::-webkit-scrollbar-thumb{background:#3f3357;border-radius:8px}
...
export function faviconSvg() {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="sag">
<rect width="64" height="64" rx="14" fill="#0f1115"/>
<g transform="translate(10 18)" fill="none" stroke-linecap="round" stroke-width="6">
<line x1="3"  y1="14" x2="3"  y2="18" stroke="#7c3aed"/>
<line x1="13" y1="9"  x2="13" y2="23" stroke="#a855f7"/>
<line x1="23" y1="4"  x2="23" y2="28" stroke="#ec4899"/>
<line x1="33" y1="11" x2="33" y2="21" stroke="#f59e0b"/>
<line x1="43" y1="14" x2="43" y2="18" stroke="#a855f7"/>
</g>
</svg>`;
}
